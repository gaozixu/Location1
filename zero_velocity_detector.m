...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [zupt ,T , sigma2_a_k,sigma2_g_k]=zero_velocity_detector(u)
...
switch simdata.detector_type
    ...
    case 'GLRT'
        [T, sigma2_a_k,sigma2_g_k]=GLRT(u);    
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [T, sigma2_a_k,sigma2_g_k]=GLRT(u)
...
N=length(u);
T=zeros(1,N);
sigma2_a_k=zeros(1,N);
sigma2_g_k=zeros(1,N);
...
for k=1:N-W+1
    ...
    for l=k:k+W-1
        ...
        T(k+3)=T(k+3)+u(4:6,l)'*u(4:6,l)/sigma2_g+tmp'*tmp/sigma2_a;    
    end 
    sigma2_a_temp = var(u(1:3,k:k+W-1),0,2); 
    sigma2_g_temp = var(u(4:6,k:k+W-1),0,2); 
    
    sigma2_a_k(k+3) = mean(sigma2_a_temp);
    sigma2_g_k(k+3) = mean(sigma2_g_temp);


end

T=T./W;
sigma2_a_k = sigma2_a_k ./mean(sigma2_a_k);
sigma2_g_k = sigma2_g_k ./mean(sigma2_g_k);
end
